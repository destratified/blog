...
<?php } ?>
<section id="testimonial" class="home_section testimonial wow zoomIn <?php echo esc_attr($class); ?>" style="background-image: url('<?php echo esc_url_raw($bg_image); ?>');" <?php echo esc_attr($section_attributes); ?>>
